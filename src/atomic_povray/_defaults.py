...
DEFAULT_ATOM_SIZE_SCALE = DEFAULT_PRESET_ATOM_SIZE_SCALES[DEFAULT_PRESET_STYLE]
...
# Baseline Finish and Material coefficients.
DEFAULT_FINISH_AMBIENT = 0.10
DEFAULT_FINISH_DIFFUSE = 0.60
DEFAULT_FINISH_PHONG = 0.0
DEFAULT_FINISH_PHONG_SIZE = 10.0
DEFAULT_FINISH_SPECULAR = 0.0
DEFAULT_FINISH_EMISSION = 0.0
