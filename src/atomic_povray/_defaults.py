...
DEFAULT_POLYHEDRON_FILTER = 0.1
DEFAULT_POLYHEDRON_TRANSMIT = 0.4
...
DEFAULT_RENDER_ANTIALIAS_THRESHOLD = None
DEFAULT_RENDER_SAMPLING_METHOD = None
DEFAULT_RENDER_DISPLAY_GAMMA = None
DEFAULT_RENDER_FILE_GAMMA = None
DEFAULT_RENDER_TRANSPARENT = False
DEFAULT_RENDER_DISPLAY = True
DEFAULT_POVRAY_EXECUTABLE = "povray"
DEFAULT_POVRAY_VERSION = "3.7"
DEFAULT_RENDER_MAX_TRACE_LEVEL = None
DEFAULT_RENDER_RADIOSITY = None
DEFAULT_RENDER_ADDITIONAL_POV = None
DEFAULT_RENDER_ADDITIONAL_INI = None
